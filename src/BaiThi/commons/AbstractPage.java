...
public class AbstractPage {
    ...
    public void cleanToElement(WebDriver driver,String locator){
        findAnElement(driver,locator).clear();
    }
    public void enter(WebDriver driver,String locator,String value){
